...
const socials = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 fill-current">
        <path d="M4.2 5.2c0-.4.3-.7.7-.7h12.2c.4 0 .7.3.7.7V18.8c0 .4-.3.7-.7.7H4.9a.7.7 0 0 1-.7-.7V5.2Zm2.8 1.6h1.1l1.7 5.8 1.8-5.8h1.1l-2.3 7.3h-1.1L7 6.8Zm7.2 0h2.7v.9h-1.8v5.5h1.8v.9h-2.7v-7.3Z" />
      </svg>
    ),
  },
];
