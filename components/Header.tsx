  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "border-border shadow-[0_10px_30px_-20px_rgba(23,63,58,0.35)]"
          : ""
      )}
    >
      <div className="relative z-50 mx-auto flex h-full max-w-6xl items-center justify-between gap-4 px-5 lg:px-8">
        ...
        <a
          href="#home"
          className="min-h-11 min-w-0 py-1"
        ...
        <div className="hidden lg:block">
          <WhatsAppButton
            className="shadow-[0_14px_24px_-18px_rgba(23,63,58,0.85)]"
            showIcon={true}
          >
            Connect on WhatsApp
          </WhatsAppButton>
        ...
        <button
          type="button"
          className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-full border border-border text-deep-teal transition-colors hover:bg-sage/30 lg:hidden"
          aria-expanded={open}
